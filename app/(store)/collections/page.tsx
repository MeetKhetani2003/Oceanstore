    ...
    <div className="bg-cream-100 min-h-screen pt-24 pb-20">
      <div className="container-x">
        ...
        <div className="mb-8 rounded-2xl bg-gradient-to-r from-ocean-500 to-ocean-700 p-8 text-white shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <h1 className="font-display text-3xl font-extrabold tracking-tight">
              {activeCategory ? activeCategory : "All Groceries"}
            </h1>
        ...
        <div className="grid grid-cols-12 gap-6 items-start">
          ...
          <aside className="col-span-12 lg:col-span-3 lg:sticky lg:top-24">
            <Suspense fallback={<div className="h-40 bg-white animate-pulse rounded-[20px]" />}>
          ...
          <main className="col-span-12 lg:col-span-9 space-y-6">
            ...
            <div className="rounded-2xl border border-line bg-white p-4 shadow-sm">
              <form method="GET" action="/collections" className="flex flex-col sm:flex-row gap-4 items-center justify-between">
            ...
            {products.length === 0 ? (
              <div className="text-center py-20 bg-white rounded-2xl border border-line shadow-sm">
                ...
                <Link href="/collections" className="mt-3 inline-block text-[13.5px] font-bold text-ocean-500 hover:underline">
                  ...
                  <div className="mt-12 flex justify-center gap-2">
                    {Array.from({ length: pages }, (_, i) => i + 1).map((p) => {
                      ...
                      return (
                        <Link
                          key={p}
                          href={`/collections?${queryParams.toString()}`}
                          className={cn(
